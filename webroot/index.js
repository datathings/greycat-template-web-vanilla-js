...
const filters = new gc.Filters(0,1000, "", ""/*, new gc.Date(0,0,0,0,0,0,0)*/, gc.time.now(), gc.TimeZone["Africa/Bamako"]);
...
let filters_update = async function(/** @type{any} */ev){
    ...
    //console.log(filters_el.value?.toJSON());
    var main_el = /** @type {gc.GuiSelect<String>}*/ (filters_el.fields.main);
    var sub_el = /** @type {gc.GuiSelect<String>}*/ (filters_el.fields.sub);
